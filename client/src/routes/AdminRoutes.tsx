...
export default function AdminRoutes() {
  return (
    <Switch>
      ...
      <Route
        path="/admin/music-journaling"
        component={AdminMusicJournalingPage}
      />
      ...
      <Route path="/admin/courses/create" component={AdminCourseFormPage} />
      <Route path="/admin/courses/:id/edit" component={AdminCourseFormPage} />
      <Route
      ...
      <Route
        ...
        component={AdminAbundanceMasteryPage}
      />
      ...
      <Route
        ...
        component={AdminSessionBannersPage}
      />
      <Route
        path="/admin/session-banner/banners/new"
        component={AdminSessionBannerFormPage}
      />
      <Route
        path="/admin/session-banner/banners/:id/edit"
        component={AdminSessionBannerFormPage}
      />
