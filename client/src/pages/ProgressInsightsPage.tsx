    ...
    <div className="mb-5 group">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span
            className={`text-sm font-semibold ${color === "brand" ? "text-brand" : "text-pink-500"
              }`}
          >
            {count}
          </span>
...
export default function ProgressInsightsPage() {
  ...
  const { toast } = useToast(); // Ensure you have useToast imported or remove if unused, but apiRequest handles errors mostly. 
  // Actually apiRequest handles the fetch, but we need to handle the response.
  ...
  const {
    ...
    queryFn: async () => {
      ...
      // apiRequest takes care of base URL and Authorization headers from Preferences
