...
export default function MoneyMasteryPage() {
  ...
  const { data: calendarData, isLoading: isLoadingCalendar } = useMoneyCalendar(
    monthKey,
    ...
    useQuery<AbundanceFeatureResponse>({
      ...
      queryFn: async () => {
        const response = await apiRequest(
          "GET",
          "/api/public/v1/features/ABUNDANCE"
        );
                ...
                <div className="grid grid-cols-7 gap-2 md:gap-1.5">
                  ...
                  {days.map((day) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={`text-xs font-medium ${isHighestDay ? "text-white" : "text-gray-800"
                            } ${hasEarning ? "mb-0.5" : ""}`}
                        >
                          {day}
                        </span>
                        ...
                        {hasEarning && (
                          <div className="h-2 flex items-center justify-center">
                            <span
                              className={`text-[10px] font-semibold tracking-tight leading-none ${isHighestDay ? "text-yellow-300" : ""
                                }`}
                            >
