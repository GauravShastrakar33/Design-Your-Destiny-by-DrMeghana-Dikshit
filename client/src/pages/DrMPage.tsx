...
export default function DrMPage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#F9FAFB] flex items-center justify-center p-6">
        <Card className="max-w-sm w-full border-0 shadow-lg rounded-3xl p-8 text-center bg-white">
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] pb-24">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-6 space-y-8">
        {/* Intro Section */}
        <motion.div
            ...
            <div className="p-5">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-500 leading-none mb-1">
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        ...
                        questionDetails?.audioUrl ? (
                          <div className="p-4 rounded-3xl bg-brand/5 border border-brand/20 shadow-sm">
                            <audio
                              controls
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              {pastQuestions.map((question, idx) => (
                <Card
                  key={question.id}
                  className="border-0 shadow-sm rounded-3xl overflow-hidden bg-white hover:shadow-md transition-shadow group"
                >
