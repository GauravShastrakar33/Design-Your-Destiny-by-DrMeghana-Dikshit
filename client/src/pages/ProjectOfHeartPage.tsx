          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  {CATEGORY_LABELS[pohState.active.category as Category] ||
                    pohState.active.category.toUpperCase()}
                </span>
                <span
                  className="text-xs font-medium px-3 py-1 rounded-full"
                  style={{
                    backgroundColor: "rgba(95,183,125,0.12)",
                    color: "#5FB77D",
                  }}
                >
                  ACTIVE
              ...
              <div className="mb-8 px-2">
                ...
                <div
                  className="flex gap-6 overflow-x-auto pb-2 px-1"
                    ...
                    {pohState.active.milestones.map((milestone) => (
                      ...
                      >
                        <motion.span
                          ...
                          style={{
                            color: milestone.achieved ? "#5FB77D" : "#CFCFCF",
                          }}
                          animate={
                            justAchievedId === milestone.id
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-4 text-center">
                A moment of awareness, practiced daily, shapes how you show up.
              </p>
            </div>
          </motion.div>
        )}
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  {CATEGORY_LABELS[pohState.next.category as Category] ||
                    pohState.next.category.toUpperCase()}
                </span>
                <span
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  {CATEGORY_LABELS[pohState.horizon.category as Category] ||
                    pohState.horizon.category.toUpperCase()}
                </span>
                <span
                  className="text-xs font-semibold px-2 py-0.5 rounded-full"
                  style={{
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              disabled={
                creatingMilestones || !newMilestones.some((m) => m.trim())
              }
              className="flex-1"
              style={{ backgroundColor: "#703DFA" }}
            >
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="py-4">
            <div className="flex gap-2 mb-4">
              ...
              <Button
                ...
                className="flex-1"
                style={
                  completeMode === "close" ? { backgroundColor: "#E5AC19" } : {}
                }
              >
                Close Early
              </Button>
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              style={{
                backgroundColor:
                  completeMode === "complete" ? "#5FB77D" : "#E5AC19",
              }}
        ...
        <DialogContent className="max-w-md max-h-[80vh] overflow-y-auto">
          ...
          <div className="flex gap-2 py-2">
            {pohState.active && (
              <Button
                size="sm"
                variant={realignTarget === "active" ? "default" : "outline"}
                onClick={() => openRealignFor("active")}
                style={
                  realignTarget === "active"
                    ? { backgroundColor: "#5FB77D" }
            ...
            {pohState.next && (
              <Button
                size="sm"
                variant={realignTarget === "next" ? "default" : "outline"}
                onClick={() => openRealignFor("next")}
                style={
                  realignTarget === "next" ? { backgroundColor: "#5865F2" } : {}
                }
              >
                Next
              </Button>
            ...
            {pohState.horizon && (
              <Button
                size="sm"
                variant={realignTarget === "horizon" ? "default" : "outline"}
                onClick={() => openRealignFor("horizon")}
                style={
                  realignTarget === "horizon"
                    ? { backgroundColor: "#8A7F5A" }
                    : {}
                }
              >
                North Star
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <Input
                value={realignTitle}
                onChange={(e) => setRealignTitle(e.target.value.slice(0, 120))}
            ...
            {realignTarget === "active" && (
              <div>
                ...
                <Textarea
                  value={realignWhy}
                  onChange={(e) => setRealignWhy(e.target.value.slice(0, 500))}
                  ...
                  <div className="space-y-2">
                    {pohState.active.milestones.map((m) => (
                      <div key={m.id} className="flex items-center gap-2">
                        <span
                          className="text-sm"
                          style={{ color: m.achieved ? "#5FB77D" : "#CFCFCF" }}
                        >
                          {m.achieved ? "●" : "○"}
                        </span>
                          ...
                          <>
                            <span
                              className={`text-sm flex-1 ${
                                m.achieved ? "text-gray-400" : "text-gray-700"
                              }`}
                            >
                              {m.text}
                            </span>
          ...
          <div className="text-center py-4">
            ...
            <DialogHeader className="mb-4">
              ...
              <DialogDescription className="text-center mt-2">
                You rated your alignment as{" "}
                <span className="font-semibold" style={{ color: "#703DFA" }}>
                  {sliderValue}/10
                </span>{" "}
                today.
              </DialogDescription>
