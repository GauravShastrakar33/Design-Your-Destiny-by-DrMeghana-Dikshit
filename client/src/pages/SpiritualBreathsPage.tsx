...
const breathworkSessions = [
  {
    ...
    description: "Start your day with revitalizing breathwork",
  },
  {
    id: 2,
      ...
      <div className="max-w-md mx-auto">
        <div className="sticky top-0 bg-background/95 backdrop-blur-sm border-b border-border z-10">
          <div className="px-4 py-4 flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-foreground">Spiritual Breaths</h1>
          </div>
        </div>

        <div className="px-4 py-6 space-y-6">
          {breathworkSessions.map((session) => (
            <div key={session.id} className="space-y-3" data-testid={`breathwork-${session.id}`}>
              <div>
              ...
              <div className="bg-card border border-card-border rounded-lg p-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">0:00 / 3:24</p>
                  </div>
                </div>
              </div>
            </div>
