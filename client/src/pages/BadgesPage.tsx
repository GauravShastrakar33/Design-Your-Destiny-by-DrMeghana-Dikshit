    ...
    return (
      ...
      >
        <div className="flex items-start gap-4">
          <BadgeIcon badgeKey={badge.key} size="lg" earned={isEarned} />
      ...
      {isLoading ? (
        ...
        <div className="max-w-md mx-auto px-4 py-6 space-y-8">
          <section>
            ...
            <div className="space-y-3">{coreBadges.map(renderBadgeCard)}</div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">{metaBadges.map(renderBadgeCard)}</div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">{adminBadges.map(renderBadgeCard)}</div>
          </section>
        </div>
      )}
    </div>
