...
const latestVideos: Video[] = [
  { id: "1", title: "Lions Gate Portal", thumbnail: "bg-gradient-to-br from-yellow-400 to-orange-500", uploadDate: "20 Oct 2025" },
  { id: "2", title: "Inner Circle Call — Turning Setbacks into Success", thumbnail: "bg-gradient-to-br from-purple-400 to-pink-500", uploadDate: "18 Oct 2025" },
  { id: "3", title: "Self Sabotage Downloads", thumbnail: "bg-gradient-to-br from-blue-400 to-cyan-500", uploadDate: "15 Oct 2025" },
  { id: "4", title: "Money Mastery", thumbnail: "bg-gradient-to-br from-green-400 to-teal-500", uploadDate: "12 Oct 2025" }
];

const dydCourses: Course[] = [
  { id: "dyd-14", title: "DYD 14", thumbnail: "bg-gradient-to-br from-purple-500 to-pink-500", year: "July 2025", type: "dyd" },
  { id: "dyd-13", title: "DYD 13", thumbnail: "bg-gradient-to-br from-blue-500 to-indigo-500", year: "April 2025", type: "dyd" },
  { id: "dyd-12", title: "DYD 12", thumbnail: "bg-gradient-to-br from-green-500 to-emerald-500", year: "January 2025", type: "dyd" }
];

const usmCourses: Course[] = [
  { id: "usm-march", title: "USM", thumbnail: "bg-gradient-to-br from-orange-400 to-red-500", year: "March 2025", type: "usm" },
  { id: "usm-jan", title: "USM", thumbnail: "bg-gradient-to-br from-cyan-400 to-blue-500", year: "January 2025", type: "usm" }
];

const uscCourses: Course[] = [
  { id: "usc-march", title: "USC", thumbnail: "bg-gradient-to-br from-pink-400 to-purple-500", year: "March 2025", type: "usc" }
];

const usbCourses: Course[] = [
  { id: "usb-feb", title: "USB", thumbnail: "bg-gradient-to-br from-teal-400 to-cyan-500", year: "February 2025", type: "usb" }
];

const moreCourses: Course[] = [
  { id: "sleep", title: "Sleep Subconscious", thumbnail: "bg-gradient-to-br from-indigo-400 to-purple-500", year: "2025", type: "more" },
  { id: "visions", title: "Build Your Visions", thumbnail: "bg-gradient-to-br from-yellow-400 to-orange-500", year: "2025", type: "more" }
];
            ...
            <div className="space-y-4">
              {dydCourses.map((course) => (
                <Card
                  ...
                  onClick={() => setLocation(`/workshops/course/${course.id}`)}
