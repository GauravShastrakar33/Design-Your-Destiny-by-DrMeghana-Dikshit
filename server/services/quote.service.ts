...
import { clearQuoteCache } from "../controllers/quote.controller";
...
export const quoteService = {
  ...
  async create(body: Record<string, any>) {
    ...
    const quote = await quoteRepository.create({ ...parsed.data, displayOrder: nextOrder } as typeof import("@shared/schema").dailyQuotes.$inferInsert);
    clearQuoteCache();
    return quote;
  },
